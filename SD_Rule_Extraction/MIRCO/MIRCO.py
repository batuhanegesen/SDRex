...
class MIRCO:
    ...
    def greedySCP(self, c, A):
        ## BURAYI INCELE.
        ## gurobiyi öğrenci mailim ile kayıt ol.
        ## solver grb kullan.
        ## başka modeller ve veri setleri ile denenecek.
        ## iris dataset bir classification veri seti, bunu deneyeyim.
        ## 3 civarı az sayıda kural çıkması lazım.
